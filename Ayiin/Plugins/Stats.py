...
from Ayiin.Database import get_gbans_count, get_served_chats, get_sudoers
from Ayiin.Inline import stats1, stats2, stats3, stats4, stats5, stats6, stats7
from Ayiin.Plugins import ALL_MODULES
...
async def gstats(_, message):
    ...
    response = await message.reply_photo(
        photo="Utils/Nande.jpg", caption="Getting Stats!"
    )
    end = datetime.now()
